...
export declare const ComboBox: (<T extends object = object>({ children, className, fullWidth, menuTrigger, ...props }: import("./combo-box").ComboBoxRootProps<T>) => import("react/jsx-runtime").JSX.Element) & {
    Root: <T extends object = object>({ children, className, fullWidth, menuTrigger, ...props }: import("./combo-box").ComboBoxRootProps<T>) => import("react/jsx-runtime").JSX.Element;
